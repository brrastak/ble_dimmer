...
flash: build
	@echo "****** FLASH ******"
	openocd -f interface/stlink-v2.cfg -f target/nrf51.cfg -c "init; reset halt; nrf51 mass_erase; program $(TARGET_HEX) verify reset exit"
	@echo "****** FLASHED SUCCESFULLY ******"

reset:
	openocd -f interface/stlink-v2.cfg -f target/nrf51.cfg -c "init ; reset ; exit"
	@echo "****** RESET ******"
